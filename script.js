...
// --- Tags-Feld beim Erstellen/Bearbeiten hinzufügen ---
function createOrEditForm(existingItem = null) {
    ...
    form.addEventListener("submit", e => {
        ...
        // Firebase speichern (falls Firebase genutzt wird)
...
// --- Button zum Erstellen neuer Kurzbefehle/Ordner ---
if (!document.getElementById("create-item-btn")) {
    ...
    createBtn.addEventListener("click", () => createOrEditForm());
    createBtn.style.display = "block";
    createBtn.style.marginTop = "10px";
    document.body.appendChild(createBtn);
}

// --- Globale Items-Variable (Firebase kann hier deine Daten füllen) ---
